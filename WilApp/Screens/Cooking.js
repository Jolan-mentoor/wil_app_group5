...
function CookingScreen() {
    ...
    <View><Text style={styles.Text14}>This course purpose is to prepare and cook nutritious family meal:</Text></View>
    ...
    <TouchableOpacity>
      <View style={styles.button6}>
        <Text style={styles.btnText2}>Nutritional requirements for a healthy body</Text>
       </View>
    </TouchableOpacity>
    <Image style={styles.background4} 
    ...
    <Image style={styles.background4} 
            ...
            <TouchableOpacity>
      <View style={styles.button6}>
        <Text style={styles.btnText3}>• Types of protein, carbohydrates and vegetables</Text>
      </View>
    </TouchableOpacity>
    <Image style={styles.background4} 
            ...
            />
             <TouchableOpacity>
      <View style={styles.button6}>
        <Text style={styles.btnText3}>Preparation and cooking of meals
    ...
    <Image style={styles.background4} 
            ...
            />
             <TouchableOpacity>
      <View style={styles.button6}>
        <Text style={styles.btnText3}>cooking of meals</Text>
      </View>
    </TouchableOpacity>
