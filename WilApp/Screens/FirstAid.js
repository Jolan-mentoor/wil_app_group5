...
function FirstAidScreen() {
  ...
  <View><Text style={styles.title2}> Our FirstAid{'\n'} Course</Text></View>
  <View><Text style={styles.Text14}>This course provide First Aid Awareness and basic life support that include::</Text></View>
