...
function GardenScreen() {
    ...
    <Image style={styles.background4} 
            source={require('../assets/img/Gardening/gardening.jpg')}
            resizeMode="cover"
            /> 
    <TouchableOpacity>
      <View style={styles.button6}>
        <Text style={styles.btnText2}>Water restrictions and the watering requirements of indigenous and exotic plants</Text>
       </View>
    </TouchableOpacity>
    <Image style={styles.background4} 
            source={require('../assets/img/Gardening/landscape.jpg')}
            resizeMode="cover"
            />
    <TouchableOpacity>
      <View style={styles.button6}>
        <Text style={styles.btnText3}>
        propagation of plants</Text>
      </View>
    </TouchableOpacity>
    <Image style={styles.background4} 
            source={require('../assets/img/Gardening/Seed.jpg')}
            resizeMode="cover"
            />
            <TouchableOpacity>
      <View style={styles.button6}>
        <Text style={styles.btnText3}>Pruning</Text>
      </View>
    </TouchableOpacity>
    <Image style={styles.background4} 
            source={require('../assets/img/Gardening/trees.jpg')}
            resizeMode="cover"
            />
             <TouchableOpacity>
      <View style={styles.button6}>
        <Text style={styles.btnText3}>Planting techniques for different plant types
    ...
    <Image style={styles.background4} 
            source={require('../assets/img/Gardening/pokes-fun-at-.jpg')}
            resizeMode="cover"
            />
             <TouchableOpacity>
      <View style={styles.button6}>
    ...
    <Image style={styles.background5} 
            source={require('../assets/img/Gardening/green.jpg')}
            resizeMode="cover"
            />
             <TouchableOpacity>
